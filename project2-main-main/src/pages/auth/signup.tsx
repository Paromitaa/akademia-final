...
export function SignupPage({ portalRole = 'student' }: SignupPageProps) {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    setLoading(true);
    try {
      await signUp(name, email, password, portalRole);
      toast.success('Account created!', {
        description: `Your ${roleTitle} account is ready. Please sign in.`,
      });
      // Redirect to the correct login portal — do NOT auto-sign in
